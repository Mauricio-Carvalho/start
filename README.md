...
Verificar as versões instaladas: Current|Wanted|Latest|Location:
npm outdated

Usar o Comando npm view

Você pode usar o comando npm view para listar todas as versões de um pacote diretamente no terminal:
npm view @angular/google-maps versions --json

"build:prod": "npm run build -- --configuration production --aot",

1. Atualize a versão do Angular CLI no seu projeto: 
  No diretório do seu projeto, execute o comando para atualizar a versão do Angular CLI local (no projeto)
    npm install @angular/cli@15.2.10 --save-dev

2. Depois de atualizar o Angular CLI, atualizar as dependências do Angular:
